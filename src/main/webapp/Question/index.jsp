...
<div class="container mx-auto py-8">
  <div class="flex justify-between items-center mb-6">
    ...
    <a href="create" class="px-4 py-2 bg-black text-white rounded shadow hover:bg-gray-800 transition">Create Question</a>
  </div>
  ...
  function renderTable(data) {
    ...
    data.forEach(function(question) {
      ...
      editBtn.onclick = function() {
        window.location.href = contextPath + '/edit?id=' + question.id;
      };
